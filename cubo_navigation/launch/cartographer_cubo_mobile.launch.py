...
def generate_launch_description():
    my_pkg_prefix = get_package_share_directory('cubo_navigation')
    ...
    cartographer_config_dir = LaunchConfiguration('cartographer_config.dir',
    ...
    configuration_basename = LaunchConfiguration('configuration_basename',
                                                 default='cubo_mobile_lds_2d.lua')
